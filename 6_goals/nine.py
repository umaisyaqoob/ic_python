...
def portfolio_volatility(weights, returns):
    print('MUHAMMAD UMAIS : PORTFOLIO VOL: ',np.sqrt(np.dot(weights.T, np.dot(returns.cov() * 252, weights))))
...
portfolio_volatility(optimized_weights_series_max_return_for_vol, returns)