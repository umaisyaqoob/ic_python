...
def target_return_portfolio(weights, returns):
    print("Muhammad Umais TARGET RETURN PORTFOLIO",np.dot(weights, returns.mean()) * 252)
...
target_return_portfolio(optimized_weights_min_vol_target_return, returns) # OK TestCase
target_return_portfolio(optimized_weights_series_min_vol_target_return, returns) # OK TestCase