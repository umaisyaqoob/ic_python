...
def neg_portfolio_return(weights, returns):
    print("Muhammad Umais PORTFOLIO :",np.dot(weights, returns.mean()) * 252)
...
# neg_portfolio_return(initial_investment, returns)  # OK and TestCase Statement
# neg_portfolio_return(equal_weights, returns)  # OK and TestCase Statement